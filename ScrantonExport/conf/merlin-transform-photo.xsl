...
<xsl:stylesheet version="2.0" 
    ...
    exclude-result-prefixes="xsl xs xdt err fn local worker">
	...
	<xsl:template match="item-photo">
		<item-photo>
			<xsl:text>ImageName&tab;</xsl:text><xsl:value-of select="./ImageName"/><xsl:text>&linebreak;</xsl:text>
			<xsl:text>UniqueId&tab;</xsl:text><xsl:value-of select="./UniqueId"/><xsl:text>&linebreak;</xsl:text>
			<xsl:text>Productname&tab;</xsl:text><xsl:value-of select="./Productname"/><xsl:text>&linebreak;</xsl:text>
			<xsl:text>Pub_date&tab;</xsl:text><xsl:value-of select="./Pub_date"/><xsl:text>&linebreak;</xsl:text>
			<xsl:text>Section&tab;</xsl:text><xsl:value-of select="./Section"/><xsl:text>&linebreak;</xsl:text>
			<xsl:text>Zone&tab;</xsl:text><xsl:value-of select="./Zone"/><xsl:text>&linebreak;</xsl:text>
			<xsl:text>Edition&tab;</xsl:text><xsl:value-of select="./Edition"/><xsl:text>&linebreak;</xsl:text>
			...
			<xsl:text>&linebreak;</xsl:text>
			<xsl:text>CropInfo1&tab;</xsl:text><xsl:value-of select="./CropInfo1"/><xsl:text>&linebreak;</xsl:text>
			<xsl:text>CropInfo2&tab;</xsl:text><xsl:value-of select="./CropInfo2"/><xsl:text>&linebreak;</xsl:text>
		</item-photo>
	</xsl:template>
